...
const DebugRabbit = () => {
	...
	const defectsOperations = [
		{
			typeExecutor: 'flat',
			configName: 'defects',
			body: {
				detectStartDate: '2021-05-01T21:00:00.000Z',
				detectEndDate: '2021-08-15T21:00:00.000Z',
			},
			output: 'data.defects',
		},
		{
			...
			body: {
				...
				fields: [
					...
					},
					{
						...
						cellStyle: {border: {right: true, bottom: true}},
					},
					{
						header: 'Описание',
						name: 'description',
				...
				data: 'data.defects.rows', // 'data.detours.rows',
			},
		...
		},
		{
			...
			body: {
				...
				name: 'Report date:JS{new Date().toUTCString()}JS',
