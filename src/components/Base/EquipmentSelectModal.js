        ...
        if(equipmentsSelected){
            if(equipmentsSelected.isGroup){
                ...
                setErrorSelect({...errorSelect,
                    text: 'Вы не можете добавить группу. Выберете оборудование.',
        ...
        >
            <div style={{height: '600px'}}>
                <AdvancedTable
                    ...
                    requestLoadRows={apiGetHierarchicalDataByConfigName('equipmentsAutoQuery')}
                    requestLoadConfig={apiGetConfigByName('equipmentsAutoQuery')}
                    onRowClick={({rowData}) =>
